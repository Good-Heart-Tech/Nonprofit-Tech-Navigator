...
1. **Open Settings** by pressing  `Windows + I` on your keyboard to open the **Settings** app.
2. Click on **Accounts** in the left-hand menu, and select the **Sign-in options** from the list.
3. Choose **PIN (Windows Hello)** and click **Set up** (or **Add** if no PIN is set yet).
4. Enter your current account password or other authentication credentials to proceed.
5. **Create Your PIN** by entering a  4-digit or longer PIN (you can include letters and symbols for added security if allowed).  Confirm the PIN by typing it again and click **OK** to save.
...
* **Biometric Integration:** Use a PIN as a backup when biometric sign-ins (like fingerprint or facial recognition) aren’t available.
