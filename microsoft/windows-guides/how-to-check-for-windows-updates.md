...
{% hint style="warning" %}
Checking for updates does not update from Windows 10 to 11.  For that, [see this article](upgrading-to-windows-11.md).&#x20;
{% endhint %}

{% hint style="info" %}
Need to check your Windows version?  [Here's how.](how-to-check-if-youre-running-windows-10-or-11.md)
{% endhint %}
